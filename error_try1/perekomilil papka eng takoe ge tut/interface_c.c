    ...
    /* [in] */ int check_eof)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &interface__MIDL_ProcFormatString.Format[60],
    ...
    /* [in] */ int index)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &interface__MIDL_ProcFormatString.Format[120],
                  ( unsigned char * )&path);
    return ( int  )_RetVal.Simple;
    ...
    /* [out] */ int *index)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &interface__MIDL_ProcFormatString.Format[162],
                  ( unsigned char * )&login);
    return ( int  )_RetVal.Simple;
